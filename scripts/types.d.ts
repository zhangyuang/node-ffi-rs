...
export type FuncConstructorOptions = {
  ...
  retType: FieldType;
  needFree?: boolean
  // default: true, whether or not free function call params memory automatically which are allocated in c side
...
export type FFIParams<T extends FieldType, U extends boolean | undefined = undefined, RunInNewThread extends boolean | undefined = undefined> = {
  ...
  // default: true, whether or not need to free the result of return value memory automatically
